		...
		<div class="row content">
			<div class="col-sm-3 sidenav">
				...
				<ul class="nav nav-pills nav-stacked">
					...
					<li><a href="https://analytics.google.com/analytics/web/#realtime/rt-location
					/a101245962w148397709p153258038/">웹로그보러가기</a>
					</c:if>
			...
			<div class="col-sm-9">
				...
				<br>
				<c:if test="${userid != null}">
				<a href="../member/logout" class="btn btn-warning"
					role="button">로그아웃</a> 
				</c:if> 
					<c:if test="${userid != null && userid.classification == 'student'}">
					<a href="../member/doattend?logout=logout"
